...
int encrypt_correct(unsigned char *plaintext, int plaintext_len,
...
int encrypt_incorrect(unsigned char *plaintext, int plaintext_len,
		      unsigned char *key, unsigned char *iv,
		      unsigned char *ciphertext)
{
	EVP_CIPHER_CTX *ctx;
...
typedef int (*encrypt_func_ptr_t)(unsigned char *plaintext, int plaintext_len,
				  unsigned char *key, unsigned char *iv,
				  unsigned char *ciphertext);
